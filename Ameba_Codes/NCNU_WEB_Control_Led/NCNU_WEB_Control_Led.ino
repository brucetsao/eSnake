      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/1H\">here</a> turn Power on<br>");
            client.print("Click <a href=\"/1L\">here</a> turn Power off<br>");
            client.print("Click <a href=\"/2H\">here</a> turn Power on<br>");
            client.print("Click <a href=\"/2L\">here</a> turn Power off<br>");
