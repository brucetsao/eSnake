...
//--game
  ...
  //StringWrite_AT_Command("AT91=("+String(bound_x1)+","+String(bound_y1)+","+String(bound_x2)+","+String(bound_y2)+",1)"); //Draw a play zone 
           ...
           //   Serial.println(")");
             ...
             if (client.available()>0)
             {
                  ...
                  */    
                  ...
                  if ((nowPosition.x == foodPosition.x) && (nowPosition.y == foodPosition.y))
                  {
                    eatFood = true;
                    Serial.println("eat food");
                    Erase(foodPosition);
                    GenFood(&foodPosition);
                    Draw(foodPosition);
                  }
                  */
